export const mockCompanies = [
        ...
        members: [
            {
                id: "member-1",
                userId: "user-123",
                companyId: "cm0a1b2c3-d4e5-6789-f0g1-h2i3j4k5l6m7",
                role: "owner",
                permissions: ["*"],
                user: {
                    firstName: "Иван",
                    lastName: "Петров",
                    email: "ivan@remontpro.ru",
            ...
            },
            {
                ...
                companyId: "cm0a1b2c3-d4e5-6789-f0g1-h2i3j4k5l6m7",
                role: "admin",
                permissions: ["view_bookings", "edit_services", "view_finance"],
                user: {
                    firstName: "Мария",
                    lastName: "Сидорова",
                    email: "maria@remontpro.ru"
                }
            }
        ]
    },
    {
        ...
        name: "ДизайнСтудия",
        slug: "designstudio",
        description: "Дизайн интерьеров под ключ. Поможем создать уют и стиль в вашем доме или офисе. Индивидуальный подход к каждому клиенту. 3D-визуализация, подбор материалов, авторский надзор.",
        tags: ["дизайн", "интерьер", "3D-визуализация", "квартиры", "дома"],
        timezone: "UTC +3",
        city: "Москва",
        currency: "RUB",
        ...
        email: "hello@designstudio.ru",
        website: "https://designstudio.ru",
        isActive: true,
        ownerId: "user-789",
        members: [
            {
